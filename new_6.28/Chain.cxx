        ...
        /*az-
          ...
          */
            //az+
              ...
              parInfo.dValues[0].push_back(
                            walkerStatisticValue[iwalk]);
              parInfo.dValues[0].push_back(randNumber[irand++]);
              parInfo.dValues[0].push_back(randNumber[irand++]);
              parInfo.dValues[0].push_back(A);
          
              for (size_t i=0; i<nPars; i++) {
                parInfo.dValues[1].push_back(
                            walkerParamValues[iwalk][i]);
                parInfo.dValues[2].push_back(
